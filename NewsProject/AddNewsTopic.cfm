             ...
             <div class="col-12">
                <form action="NewsTopicCommit.cfm" method="post">
                   <div class="mb-3 text-center py-3">
                      ...
                      <cfoutput> <h2 class="fw-bold">HABER KONUSU EKLE</h1> </cfoutput>
                   ...
                   <div class="mb-3">
                      <label for="slugtopic" class="form-label">Slug (URL)</label>
                       <input type="text" name="slugtopic" class="form-control" id="slugtopic">
                   </div>
    
                   <div class="d-flex justify-content-around py-4 my-5 bg-color-gray"> 
                        <input type="submit" value="EKLE" class="btn btn-success" style="width:100px">
                        <input type="hidden" name="action" value="add">
                        <a class="btn btn-primary" style="width:100px" href="UpdateNewsTopic.cfm"> GÜNCELLE </a>
                        <a class="btn btn-danger " style="width:100px" href="DeleteNewsTopic.cfm"> SİL </a>
                   </div>
