...
<html lang="tr">
 ...
 <body>
                  ...
                  <div class="col-12">
                     <form action="NewsTopicCommit.cfm" method="post">
                        ...
                        <div class="mb-3 text-center py-2">
                            ...
                            <h2 class="fw-bold mb-4">HABER KONUSU SİL</h2> 

                            <div class="alert alert-danger" role="alert">
                                Eğer Bu İşlemi yaparsanız ilgili alana ait tüm haberlerde silinecektir.
                                <br>
                                Onaylıyor musunuz?
                            </div>
                       ...
                       <select name="iddelete" id="iddelete" class="form-select" size="3" aria-label="Size 3 select example">
                        ...
                        <div class="text-center py-4 my-5 bg-color-gray"> 
                            ...
                            <a href="" id="dynamicurl" class="btn btn-danger" style="width:100px">SİL</a>
    ...
    <script src="JS/DynamicSelectDelete.js"></script>
 </body>
