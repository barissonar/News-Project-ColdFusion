       ...
       <div class="col-12">
        <form action="NewsContentCommit.cfm" method="post" enctype="multipart/form-data" class="mt-5">
            ...
            <div class="mb-3 text-center py-3">
              ...
              <cfoutput> <h2 class="fw-bold">HABER EKLE</h1> </cfoutput>
            ...
            <div class="mb-3">
                 <label for="header" class="form-label">Haber Başlığı</label>
            ...
            <div class="mb-3">
                 ...
                 <input type="text" name="slugcontent" class="form-control" id="slugcontent" >
            </div>
